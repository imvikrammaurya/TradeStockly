        ...
        <div className="container mx-auto px-10 pt-10">
          ...
          <div className="flex flex-col item text-xs text-gray-400 mb-2">
            <p>
              ...
              Registration no.: INZ0002343433431633 CDSL/NSDL: Depository
              services through TradeStockly Broking Ltd. – SEBI Registration
              no.: IN-DP-4341-20149 Registered Address: TradeStockly Broking
              Ltd., #1534/1544, 4th Cross, Dollars Colony, Opp. Clarence Public
            ...
            <p>
              ...
              SEBI SCORES: Register on SCORES portal. Mandatory details for
            ...
            <p>
              ...
              find anyone claiming to be part of TradeStockly and offering such
              services, please{" "}
              <a href="" className="text-blue-400">
