    ...
    <>
      <div className=" w-full ">
        <div className="container mx-auto px-4 sm:px-98">
          <div className="flex flex-col items-center content-center mt-16 sm:mt-30">
            <div className="text-center  mx-4 sm:mx-10 my-8 sm:my-15">
              <p className="text-lg sm:text-2xl font-[510] px-4 sm:px-10">
                We pioneered the discount broking model in India. Now, we are
                breaking ground with our technology.
              </p>
            </div>
            <div className="h-px w-full bg-gray-300 my-3 sm:my-6 mb-10 sm:mb-20"></div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
              <div>
                <p className="mb-4">
                  ...
                  named the company TradeStockly, a combination of Zero and
